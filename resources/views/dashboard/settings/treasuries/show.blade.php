                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input readonly name="name" id="name" type="text" value="{{ old('name', $treasury->name) }}"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select disabled name="is_master"
                                class="form-select form-control bg-white @error('is_master') is-invalid @enderror"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input readonly name="last_payment_receipt" id="last_payment_receipt"
                                ...
                                placeholder="إدخل رقم الايصال :" oninput="this.value=this.value.replace(/[^0-9.]/g,'');">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input readonly name="last_collection_receipt" id="last_collection_receipt"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select disabled name="active" class="form-select form-control bg-white @error('active') is-invalid @enderror"
                                aria-label="Default select example">
