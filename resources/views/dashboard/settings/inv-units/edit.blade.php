                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="is_master"
                                    ...
                                    <option @if (old('is_master', $invUnit->is_master) == TreasuryIsMaster::Master) selected @endif
                                        value="{{ TreasuryIsMaster::Master }}">
                                        {{ TreasuryIsMaster::Master->label() }}</option>
                                    <option @if (old('is_master', $invUnit->is_master) == TreasuryIsMaster::SubBranch) selected @endif
