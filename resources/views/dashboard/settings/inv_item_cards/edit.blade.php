                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="active"
                                    ...
                                    <option @if (old('active', $invItemCard->active) == StatusActiveEnum::Active) selected @endif
                                        value="{{ StatusActiveEnum::Active }}">
                                        {{ StatusActiveEnum::Active->label() }}</option>
                                    <option @if (old('active', $invItemCard->active) == StatusActiveEnum::Inactive) selected @endif
