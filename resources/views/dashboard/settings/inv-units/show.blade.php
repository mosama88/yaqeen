...
@section('content')
    @include('dashboard.layouts.breadcrumb', [
        'titlePage' => 'عرض الوحدة',
        'PreviousPage' => 'جدول الوحدة',
        'UrlPreviousPage' => 'invUnits.index',
        'currentPage' => 'عرض الوحدة',
    ])
        ...
        <div class="col-lg-12 mt-4">
            <div class="card rounded shadow">
                <div class="p-4 border-bottom">
                    <h5 class="title mb-0"> عرض الوحدةة </h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="table-responsive bg-white rounded shadow">
                            <table class="table table-center table-padding mb-0">
                                <tbody>
                                    <tr>
                                        <td class="h6 ps-4 py-3 bg-light">أسم الوحدةه</td>
                    ...
                    <div class="row my-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <span class="h5 mb-0">الوحدة الفرعية التى سوف تسلم عهدتها الى الوحدةه <strong
                                            ...
                                            <div class="accordion-body text-muted">
                                                <form
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        <label class="form-label">أختر الوحدةه الفرعية<span
                                                                class="text-danger">*</span></label>
                                                        <select name="invUnits_can_delivery"
                                                            class="form-select form-control @error('invUnits_can_delivery') is-invalid @enderror"
                                                            aria-label="Default select example">
                                                            <option selected value="">-- أختر الوحدةه --</option>
                                                            @forelse ($invUnits as $treasury)
                                        ...
                                        <tr class="shop-list">
                                            ...
                                            <td>
                                                <a href="javascript:void(0)"
                                                    class="text-dark">{{ $info->invUnitsCanDelivery->name }}</a>
                                            </td>
